...
int main(int argc, char *argv[])
{
	...
	scattervTime = MPI_Wtime() - scattervTime;
	cout << "scattervTime = " << scattervTime << endl;
	...
	double algorithmTime = MPI_Wtime();
	double sendrecvTime = 0;
	for (int count = 0; count < (int)sqrt(procNum); count++)
	{
		...
		tmp = MPI_Wtime() - tmp;
		sendrecvTime += tmp;
		//cout << "sebdrecvTime = " << sendrecvTime << endl;
	}
	algorithmTime = MPI_Wtime() - algorithmTime - sendrecvTime;
	cout << "algorithmTime = " << algorithmTime << endl;
	...
	gathervTime = MPI_Wtime() - gathervTime;
	cout << "gathervTime = " << gathervTime << endl;
